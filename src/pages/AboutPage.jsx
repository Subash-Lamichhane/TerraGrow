          ...
          <div className="grid gap-6">
            <div className="grid gap-2">
              ...
              <p className="text-muted-foreground">
                Determine the nutrient levels, pH, and other key characteristics of your soil to identify the plants
            ...
            <div className="grid gap-2">
              ...
              <p className="text-muted-foreground">
                Our experts will provide personalized plant recommendations based on your unique soil and environmental
                conditions, helping you achieve the best possible results.
              </p>
            </div>
          </div>
        </div>
